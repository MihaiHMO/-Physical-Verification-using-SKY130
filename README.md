...
Excercise 3:
 ...
 We see that some compoennts that are actually in the layout like taps an fill are not found in the schematic spice.
 If we check the veriflog and layout we find the tap and fill items - this is because in the lvs setup file it is defined to ignor them in certain cases that are dependedt on a variable.
 ...
 ![](Day5/l5-71 .png)
 The tehnic used in the setup file is to ignor all the fill and tap cells so we can look in the verilog.
 ...
 Ex8 (l9):
 In this case the cells look ok becasu they are coming ffrom a vendor libreary but on the otp level there are some mismatches.
 This must be solved first because the net errors generated by them are even more.
 The error are some mismatch in the decapo number, a  missing dide, some extra elements like tap and fill.  
 ...
 But some of them mus tbe corected in the layout ec: nfet drom the exercise.
 ![](Day5/l5-111 .png)
 ![](Day5/l5-112 .png)
